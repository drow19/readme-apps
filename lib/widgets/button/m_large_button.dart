...
class MLargeButton extends StatelessWidget {
  ...
  ///The button's outline color when set typeButton = MTypeButton.outline
  ...
  Widget build(BuildContext context) {
    // size button
    const double sizeHeight = 56;
    const double sizeIcon = 32;
    const double marginIcon = 12;
