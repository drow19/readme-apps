...
class MInputBorder extends InputBorder {
  ...
  /// A shadow cast by this box behind the box.
  ...
  @override
  int get hashCode =>
      Object.hash(borderSide, borderRadius, gapPadding, boxShadow, fillColor);
}
